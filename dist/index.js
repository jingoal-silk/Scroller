...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentListView = __webpack_require__(294);

	var _componentListView2 = _interopRequireDefault(_componentListView);
	    ...
	    (0, _createClass3.default)(Example, [{
	            ...
	            return this.state.lists.map(function (list) {
	                return _react2.default.createElement(
	                    ...
	                    { onClick: function onClick() {
	                            _this2.scroller.simulatePullRefresh();
	                        }, key: 'list' + _this2.index,
	        ...
	        value: function fetchData(type, resolve, reject) {
	            ...
	            ajax({
	                ...
	                var lists = data.value.list;

	                _this3.setState({
	                    lists: type === 'refresh' ? lists : _this3.state.lists.concat(lists)
	                });
	            }).catch(function () {
	                if (reject) {
	                    reject();
