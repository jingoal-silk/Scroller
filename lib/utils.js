...
function click(e) {
    ...
    if (!/(SELECT|INPUT|TEXTAREA)/i.test(target.tagName)) {
        ...
        ev.initEvent('click', true, true, e.view || window, 1, target.screenX || 0, target.screenY || 0, target.clientX || 0, target.clientY || 0, !!e.ctrlKey, !!e.altKey, !!e.shiftKey, !!e.metaKey, 0, null);
